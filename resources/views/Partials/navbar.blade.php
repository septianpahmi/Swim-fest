<body>
    <nav class="flex justify-between items-center py-4 px-6 bg-white shadow-md">
        ...
        <div class="md:hidden">
            <button id="menu-toggle" class="text-teal-800 focus:outline-none">
                <!-- Ikon Hamburger -->
        ...
        <!-- Menu Items -->
        <ul id="menu"
            class="hidden md:flex md:space-x-6 md:ml-auto absolute md:static top-16 left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none">
            <li>
                <a href="#"
