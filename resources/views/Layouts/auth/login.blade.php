        ...
        <div class="flex min-h-screen w-full flex-wrap items-stretch bg-white px-4 md:py-12">
            <div class=" md:flex md:w-1/2 md:flex-col md:items-center md:justify-center md:ml-12">
                <div class="w-full px-4 text-star text-xs lg:w-3/4">
                    <img src="/image/logo/swimfest-primary-logo-10.png" class="mb-8 h-10" alt="">
                    <h1 class="mb-2 text-3xl font-bold text-gray-800 ">MASUK</h1>
                    ...
                    <div class="mt-6 text-gray-600 dark:text-gray-400">
                        Belum punya akun?
                        <a class="font-medium text-indigo-600 underline" href="#">Daftar</a>
                    </div>
                </div>
            </div>
